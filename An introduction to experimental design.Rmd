...
knitr::include_graphics("images/ssizeCalculator1.png")
```

[MedCalc Sample size calculator ](https://www.medcalc.org/en/calc/sample-size-comparison-of-means.php)
...
t [3,1] <- paste("1 factor (k levels);", "1 block (l level), k*l EU", sep="\n")
