...
3. The way treatment levels are assigned
to the experimental units, that is, _the experimental design_
...
- Avoid biases or systematic errors
- It allows a precise estimation of the response, which implies that the random error is as low as possible.
- It allows an adequate estimation of the error.
- It has wide validity: the experimental units are a sample of the population in question, so it is possible to extrapolate the conclusions of the sample to the population.
