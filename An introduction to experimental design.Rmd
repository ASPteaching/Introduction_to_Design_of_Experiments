...
- Sometimes the design of the experiment is confused with its analysis, which is carried out using "Analysis of the Variance" or ANOVA techniques.
...
- Obviously, if it is not possible to distribute the samples evenly between the blocks, the situation becomes complicated and we are often faced with _unbalanced designs_
